...
class DataConfig:
    ...
    csv_path: str | None = "data/raw/sp500_investing.csv"
...
class ModelConfig:
    ...
    param_cache_path: str | None = None
    retrain_model: bool = True
    checkpoint_dir: str = "outputs/sp500/model_weights"
...
def load_config(path: str | Path) -> AppConfig:
    ...
    return AppConfig(
        ...
        conformal=_section(ConformalConfig, raw, "conformal"),
